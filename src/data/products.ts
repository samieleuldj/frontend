...
export const products: Product[] = [
  {
    ...
    images: [
      ...
      '/products/thermal-massage-brace/detail.png',
      '/products/thermal-massage-brace/solution.png',
    ],
    beforeImage: '/products/thermal-massage-brace/problem.png',
    afterImage: '/products/thermal-massage-brace/solution.png',
    usageSteps: [
    ...
    problemText:
      'آلام الركبة، الكوع أو الكتف من الشغل، الرياضة، أو التقدم في السن... تخلّيك ما تقدرش تتحرك براحة. الحرارة الباردة، التصلّب، والتعب في المفاصل يقلّلو من جودة يومك.',
    solutionText:
      'جهاز 3 في 1 يجمع بين العلاج الحراري العميق والتدليك بالاهتزاز في قطعة واحدة. ينشّط الدورة الدموية، يرخّي العضلات، ويريح المفاصل — للركبة، الكوع والكتف. سهل، محمول، ويستعمل في البيت أو المكتب.',
    features: [
      '3 في 1: ركبة + كوع + كتف — قطعة واحدة متعددة الاستعمال',
      'تدفئة + اهتزاز — يريح العضلات وينشّط الدورة الدموية',
      'شاشة LED + أزرار لمس — تحكم سهل في الحرارة والوضع',
      'Velcro قابل للتعديل — يناسب مختلف المقاسات',
      'خفيف ومحمول — للبيت، المكتب، أو بعد التمرين',
    ],
    reviews: [
      {
        name: 'Nadia H.',
