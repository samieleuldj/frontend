...
export const products: Product[] = [
  ...
  },
  {
    ...
    name: 'موكات عازلة للكابو — مقاس حسب سيارتك',
    description:
      'عزل وحماية مثالية لمحرك سيارتك — يقلّل الحرارة، يخفّض الضجيج، يحمي الكابو من الصدأ. اختار ماركة وموديل سيارتك ونوصلك الموكات المناسبة.',
    price: 3900,
    oldPrice: 5500,
    badge: 'الأكثر طلباً 🚗',
    rating: 4.9,
    ...
    solutionText:
      'الموكات العازلة تركّب تحت غطاء السيارة (الكابو) — تقلّل الحرارة، تخفّض الضجيج، تحمي من الصدأ، وتعطي مظهر أنيق. مناسبة لأكثر من 20 ماركة سيارة.',
    usageSteps: [
