...
export const products: Product[] = [
  ...
  },
  {
    ...
    name: 'موكات عازلة تحت الكابو — مقاس حسب سيارتك',
    description:
      'موكات عزل عالية الجودة تحت غطاء السيارة — تقلّل الحرارة والضجيج، تحمي الكابو من التآكل، وتركيبها ساهل. اختار ماركة وموديل سيارتك ونوصلك المقاس المناسب.',
    price: 3900,
    oldPrice: 5500,
    badge: 'الأكثر طلباً 🚗',
    rating: 4.9,
    ...
    solutionText:
      'الموكات العازلة تركّب تحت الكابو — تقلّل الحرارة، تخفّض ضجيج الموتور، تحمي من الصدأ، وتعطي مظهر أنيق. نوجهّزلك المقاس حسب الماركة والموديل مع مشابك التثبيت.',
    usageSteps: [
      'اختار ماركة وموديل سيارتك في الفورم — نجهّزلك الموكات المناسبة.',
      'نظّف السطح الداخلي للغطاء قبل التركيب.',
      'ثبّت الموكات حسب ثقوب التثبيت الأصلية.',
...
export const DEFAULT_REVIEWS: ProductReview[] = [
  ...
  },
  {
    ...
    city: 'الجزائر',
    initial: 'ز',
    text: 'منتج أصلي وجودة مليحة. نرجع نشري من أوتو بلاس ديزاد.',
  },
];
